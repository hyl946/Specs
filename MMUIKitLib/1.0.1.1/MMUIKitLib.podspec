...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.description      = "this is MMUIKitLib"

  s.homepage         = 'https://github.com/hyl946/MMUIKitLib'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'hyl946' => 'hyl946@163.com' }
  s.source           = { :git => 'https://github.com/hyl946/MMUIKitLib.git',:tag => s.version }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.ios.deployment_target = '8.0'

  s.source_files = 'MMUIKitLib/Classes/Class/*'
